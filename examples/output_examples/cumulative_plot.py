from tilepy.tools.PlotCumulativeCoverage import ObtainCumulativeProbabilityPlot,ObtainCumulativeProbabilityPlotCTA, ObtainCumulativeProbabilityPlotLog

#ObtainCumulativeProbabilityPlot('S190814bv/PGalinFoV_NObs/SuggestedPointings_GWOptimisation.txt','S190814bv', 'Pgal')
ObtainCumulativeProbabilityPlot('bn231012231_PAPER.fit/PGWinFoV_NObs/SuggestedPointings_GWOptimisation.txt','GRB 231012A', 'PGW')
...
ObtainCumulativeProbabilityPlot('S190814bv_PAPER/PGalinFoV_NObs/SuggestedPointings_GWOptimisation_noHA.txt','S190814bv', 'Pgal')
ObtainCumulativeProbabilityPlot('S190814bv_PAPER/PGalinFoV_NObs/SuggestedPointings_GWOptimisation_noHA.txt','S190814bv', 'PGW')
