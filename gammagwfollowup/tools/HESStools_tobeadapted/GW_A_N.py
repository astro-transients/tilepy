...
hdu = fits.open('/Users/hashkar/Desktop/GW_HESS_PUBLICATION/GW_ANALYSIS_MAPS/S190512at_IntULMap_Stereo1Std_E1-10.fits')[1]
wcs = WCS(hdu.header)
data = hdu.data
data[data==0] = np.nan
...
pos=ax_inset.imshow(data, cmap=coolheat,
