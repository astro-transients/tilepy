...
def CubeSimulationSingleObservation_dynamicSpectrum(InputListrun,InputListMergerID,pointing,nP,Source,IRFfilename,InputObservationTime,datasetDir,outDir):
...
def CubeSimulationSingleObservation_singleSpectrum(InputListrun,InputListMergerID,pointing,nP,Source,IRFfilename,InputObservationTime,datasetDir,outDir):
