...
def LoadHealpixMap(thisfilename):
    """
    Bottom-level function that downloads HEALpix map and keep in cache. 
   ...
   :return tprob : array of p-values as a function of sky position
    ...
    :rtype: array
    '''
    PrintFileName = "Loading HEALPix map from file: " + thisfilename
    print(PrintFileName)
...
def ComputeProbGalTargeted(prob, time, finalGals, visiGals, allGals, tsum_dP_dV, talreadysumipixarray, nside, thisminz,obspar,counter,dirName):
