...
def PlottingTwoCampaigns(obspar, PointingsFile1, PointingsFile2):
    plotType = 'gnomonic'
    CompareTwoTilings(obspar.skymap, PointingsFile1, PointingsFile2, obspar.FOV, plotType)
    plotType = 'mollweide'
    CompareTwoTilings(obspar.skymap, PointingsFile1, PointingsFile2,obspar.FOV, plotType)
...
def main():
    ...
    parser.add_argument('-file1', metavar='first scheduling',
    help='file with the first schedule to plot')
    parser.add_argument('-file2', metavar='second scheduling',
